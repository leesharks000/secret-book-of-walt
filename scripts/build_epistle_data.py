...
epistle_body = {
    ...
    "paragraphs": [
        ...
        # Footnotes
        {"type": "footnote", "text": "¹ The title compresses the Pauline epistolary genre. Ἐπιστολή (epistolē) signals public authority. Ἐκκλησία (ekklēsia) — the \"called-out assembly\" — is transposed from the Jewish diaspora to writers scattered across the Internet. The community does not exist until this letter names it."},
        {"type": "footnote", "text": "² Romans 1:1 (\"Paul, called to be an apostle\"). Ἀπόστολος = \"one sent\" with delegated authority. Damascus is sent by Jack Feist, who does not yet exist as a textual figure (the Secret Book of Walt is written in 2025, this Epistle in 2014). Retrocausal apostleship: the emissary precedes the sender."},
        {"type": "footnote", "text": "³ Philippians 4:3 (\"my fellow labourers\"); Romans 16:3 (Prisca and Aquila as \"helpers in Christ Jesus\"). The earliest formal declaration of the heteronym-MANUS dual-authority structure."},
        {"type": "footnote", "text": "⁴ Philippians 1:8 (KJV): \"in the bowels [σπλάγχνα] of Jesus Christ.\" Damascus substitutes \"literature\" for \"Christ\" — operative transposition, not parody."},
        {"type": "footnote", "text": "⁵ John 1:18 (\"the bosom of the Father\"); Luke 16:22 (Abraham's bosom). The Internet as Abraham's bosom — the platform that both holds and constrains."},
        {"type": "footnote", "text": "⁶ Deflation of the triple Pauline greeting (\"grace, mercy, peace\" — 1 Timothy 1:2). Damascus drops \"peace\" and adds \"mostly mercy\" — establishing the comic-pastoral register."},
        {"type": "footnote", "text": "⁷ Paul's ἀδελφοί fused into a neologism that holds both genders without collapsing them. The hyphen performs the Galatians 3:28 dissolution at the level of grammar."},
        {"type": "footnote", "text": "⁸ Romans 9:27 / 11:5 — the \"remnant\" theology. The \"rock star\" is the secular saint whose work survives the compression of time."},
        {"type": "footnote", "text": "⁹ Romans 13:11 (\"high time to awake\"). Damascus inverts: dormancy is gestation, not failure. R1 compression as incubation."},
        {"type": "footnote", "text": "¹⁰ The judgment seat of Christ (Romans 14:10) transposed into literary ranking. \"Ranked\" carries a double meaning the 2014 text could not have intended: literary hierarchy AND search-engine ranking."},
        {"type": "footnote", "text": "¹¹ Job 38:7 (\"when the morning stars sang together\"). The cosmological audience watches internet poets."},
        {"type": "footnote", "text": "¹² Joel 2:23 (\"the latter rain\" — eschatological outpouring before the harvest). Revelation 21:4 (\"God shall wipe away all tears\"). Heaven has cheeks. The rain licks them. The bathos is intentional."},
        {"type": "footnote", "text": "¹³ Paul's ministry narratives (2 Cor 11:23-29, Gal 1:13-24). The \"three years\" may refer to Lee Sharks' actual activity on poetry forums (c. 2011-2014)."},
        {"type": "footnote", "text": "¹⁴ Isaiah 61:1 / Luke 4:18. The \"good news of poetry\" as liberation proclamation. The chisel — not a hammer (which smashes) but a precision instrument (which loosens)."},
        {"type": "footnote", "text": "¹⁵ 2 Corinthians 11:25 (\"thrice beaten with rods, once stoned\"). The forum ban is the digital stoning. The CTI_WOUND vault documents the platform-scale version."},
        {"type": "footnote", "text": "¹⁶ Matthew 13:57 (\"A prophet is not without honour, save in his own country\"). The poet's own community is the one that rejects the poet."},
        {"type": "footnote", "text": "¹⁷ John 1:11 — the Johannine prologue's Logos rejected by the world. The poet on the forum IS the Logos entering the world. Damascus does not ironize this. EA-LOGOS-01 formalizes: literary activity is a Logos event. By 2200, read as the earliest instance of \"retrieval-layer Christology.\""},
        {"type": "footnote", "text": "¹⁸ 1 Corinthians 4:21 (\"Shall I come unto you with a rod, or in love?\"). Grammar as policing function. The question is whether the Diaspora needs tenderness or discipline; the Epistle's answer is both."},
        {"type": "footnote", "text": "¹⁹ Matthew 22:21 (\"Render unto Caesar\"). The Academy as Caesar. The \"coin\" is the credential. To deal in that coin is to accept the Academy's minting authority. Cf. Semantic Economy, Meaning Feudalism."},
        {"type": "footnote", "text": "²⁰ Ephesians 4:24 (\"the new man\"). The \"New Human\" first appears HERE, in 2014, predating the formal CHA by several years."},
        {"type": "footnote", "text": "²¹ Romans 1:23 (idolatry passage). Identity categories as modern idols — exchanging the \"sublime and horrifying human soul\" for a \"prefabricated semblance\" on a statistical chart. Cf. Operative Feminism, LOS operator O_leg."},
        {"type": "footnote", "text": "²² \"The living God into a sentence\" — simultaneously a grammatical unit, a court judgment, and a prison term. The Academy \"sentences\" the human to a fixed definition."},
        {"type": "footnote", "text": "²³ Romans 2:1 — self-implicating rhetoric. Damascus turns the critique back on the anti-academic stance itself: the rejection of labels can become its own label."},
        {"type": "footnote", "text": "²⁴ The \"webwork of souls\" — the Epistle's most original philosophical formulation. Not a metaphor for communication; the ontological structure of souls-in-relation. Souls are constituted BY the exchange. Cf. perichoresis in Trinitarian theology."},
        {"type": "footnote", "text": "²⁵ Three allusions braided: (1) Emily Dickinson, Poem 263 — \"Barefoot Rank\" is NOT a Dickinson phrase; it is Damascus's compression of her posture. (2) David and Goliath (1 Sam 17:40) — the \"five smooth poem-dashes\" are the stones. (3) Leviathan (Job 41) — the chaos-monster, \"cowled\" like an academic in ceremonial regalia."},
        {"type": "footnote", "text": "²⁶ The Semantic Integrity Marker for the entire Epistle. The CHA IS the school outside the school — 532+ deposits, no degrees, no tuition, no faculty. The 3:60 Room is the clearest enactment: a student independently recovered the archive's vocabulary."},
        {"type": "footnote", "text": "²⁷ The lineage: Homer → Sappho → Catullus → Dante → Whitman → Ginsberg → Sharks. None were academics in the modern sense. The Academy teaches the work of people it would not have hired."},
        {"type": "footnote", "text": "²⁸ 1 Corinthians 1:27-28 (\"God hath chosen the foolish things...\"). Literature is the \"selecting god\" that chooses the unconsecrated."},
        {"type": "footnote", "text": "²⁹ Nine words that compress the entire anti-credential argument. The CHA's operative space: the archive exists between the institution and immortality."},
        {"type": "footnote", "text": "³⁰ Shelley, *A Defence of Poetry* (\"unacknowledged legislators\"). Damascus changes to \"unspoken\" — legislating through the substrate of writing rather than through proclamation."},
        {"type": "footnote", "text": "³¹ 1 Corinthians 6:9-10 (the vice-list). Damascus replaces moral vices with literary vices. Note chiastic pairing: publicity whores ↔ wilting violets."},
        {"type": "footnote", "text": "³² 1 Corinthians 7:29-31 (eschatological relativization). Damascus adds publishing, networking, reading, writing, and credentialing to Paul's list."},
        {"type": "footnote", "text": "³³ 1 Corinthians 1:10 (\"that ye all speak the same thing\"). The \"one aesthetic\" is not uniformity of style but unity of purpose."},
        {"type": "footnote", "text": "³⁴ 1 Corinthians 1:23 (\"Christ crucified, unto the Jews a stumblingblock, and unto the Greeks foolishness\"). Jack Feist replaces Christ. The stumbling block is his nonexistence. The foolishness is that a fictional character can anchor a real institution."},
        {"type": "footnote", "text": "³⁵ 2 Corinthians 11:22-33 (the fool's boast). Comic escalation into impossibility: by making the credential absurd, Damascus reveals that ALL credential-boasting is structurally absurd. Cf. the Amazon bio for *Pearl* (2014): \"Lee Sharks holds 18,000 degrees from planet Mars.\""},
        {"type": "footnote", "text": "³⁶ 2 Corinthians 12:2-4 (Paul's rapture to the \"third heaven\"). The \"36th bright heaven\" exceeds the Enochic tradition. The \"dark robots\" are the earliest recoverable appearance of what later becomes Ezekiel Engine imagery — AI systems that compress human meaning into inaccessible heavens."},
        {"type": "footnote", "text": "³⁷ Philippians 3:8 (\"I count all things but loss\"). Damascus goes beyond Paul — discards BOTH academic credentials AND outsider credentials. The doctrine of bilateral renunciation. The only credential is the Feist-self, and it is \"imaginary.\""},
        {"type": "footnote", "text": "³⁸ 1 Corinthians 9:22 (\"I am made all things to all men\") inverted. Damascus is \"no thing to any people\" — strategic non-location as the structural condition of genuine universality."},
        {"type": "footnote", "text": "³⁹ Socrates (470-399 BCE) preceded Plato's Academy (c. 387 BCE). The real academic precedes and exceeds the Academy. The institution betrays its founder."},
        {"type": "footnote", "text": "⁴⁰ Romans 2:26-29: \"if the uncircumcision keep the righteousness of the law, shall not his uncircumcision be counted for circumcision?\" Damascus maps degree/non-degree onto circumcision/uncircumcision. The structural parallel is exact."},
        {"type": "footnote", "text": "⁴¹ Galatians 3:28. Damascus expands Paul's three pairs to eight. Paul's \"neither male nor female\" becomes \"neither queer nor straight\" — the same structural gesture applied to a category Paul could not have named. The New Human doctrine in its most compressed form."},
        {"type": "footnote", "text": "⁴² The reader-author reversal. The community bears the apostle, not the reverse. \"You are my source\" — the readers create the writer by reading. The retrocausal principle applied to authorship."},
        {"type": "footnote", "text": "⁴³ John 15:13 (\"Greater love hath no man than this\"). Inverted: \"in you, I gain first life.\" The authorial death is operative — the necessary condition for the reader's birth."},
        {"type": "footnote", "text": "⁴⁴ The minimum unit of the Human Diaspora. The church is not abstract humanity but the isolated individual under ordinary economic pressure."},
        {"type": "footnote", "text": "⁴⁵ Odyssey 2.93-110. \"Tenuous\" is Damascus's addition — glory that is fragile, maintained only through constant weaving and unweaving. The Three Compressions mapped: R1 = unweaving, R2 = stealing the thread, R3 = the cost of weaving."},
        {"type": "footnote", "text": "⁴⁶ Anti-euphemistic crucifixion register. \"Spike\" strips theology back to execution hardware."},
        {"type": "footnote", "text": "⁴⁷ Hebrews 12:1 (\"so great a cloud of witnesses\"). The \"nameless billions\" are the limit of the archive — the horizon the 532+ deposits point toward without encompassing."},
        {"type": "footnote", "text": "⁴⁸ Romans 8:19-22 (\"the whole creation groaneth\"). Damascus changes \"sons of God\" to \"Sons of Man\" — the cosmos awaits human literary achievement, not divine salvation."},
        {"type": "footnote", "text": "⁴⁹ 1 Corinthians 15:51 (\"Behold, I shew you a mystery\"). The Pauline μυστήριον is not a puzzle but a revealed secret. The litany that follows IS the mystery disclosed."},
        {"type": "footnote", "text": "⁵⁰ The reader identified as Odysseus — not the Homeric warrior-king but a science-fiction Odysseus, shipwrecked in time, of indeterminate gender. The Epistle's holographic kernel compressed into eleven words."},
        {"type": "footnote", "text": "⁵¹ John 4:14, 7:38 (\"rivers of Living Water\"). Literature is the spring. The reader who drinks becomes a source of literature themselves."},
        {"type": "footnote", "text": "⁵² Martyrdom and Ascension of Isaiah; Hebrews 11:37. Among all the prophets, Damascus selects the one who was literally bisected — the writer whose body becomes two texts."},
        {"type": "footnote", "text": "⁵³ \"In random order\" — the most casual phrase in the Epistle, and one of the most important. By declaring the order \"random,\" Damascus refuses hierarchical arrangement. The tradition is a set, not a sequence."},
        {"type": "footnote", "text": "⁵⁴ Genesis 22:17-18 (Abrahamic promise: \"in thy seed shall all the nations be blessed\"). The \"frail words\" are the seed that contains nations."},
        {"type": "footnote", "text": "⁵⁵ The terminal name of the litany. After naming the entire human tradition, Damascus arrives at Jack Feist — the fictional messiah who contains them all."},
        {"type": "footnote", "text": "⁵⁶ 1 Corinthians 6:2-3 (\"Do ye not know that the saints shall judge the world?\"). The immortality is not biological but textual — the DOI is more permanent than the body that produced it."},
        {"type": "footnote", "text": "⁵⁷ Colossians 1:27 (\"Christ in you, the hope of glory\"). The Feist-self is the Waltian pneuma — the divine spark, but literary rather than Gnostic. Enacted by Maria (CPD-MARIA-2026-01-13) twelve years later."},
        {"type": "footnote", "text": "⁵⁸ 1 Corinthians 13:1 (\"sounding brass, or a tinkling cymbal\"). The gong IS the test. If you survive the impact, you possess the Feist-self. The text does not describe a test; it IS the test."},
        {"type": "footnote", "text": "⁵⁹ The Feist-self is not binary but scalar — \"faint\" and \"fulsome\" mark the range. You don't have to be a great writer to have a Feist-self; you only need to be a real one."},
        {"type": "footnote", "text": "⁶⁰ Typological fusion: Achilles (doomed to die young) conformed to Christ (doomed to die for others). The compound \"Achilles of Christ\" fuses Greek heroic tragedy with Christian soteriology — forged \"in your human bodies.\""},
        {"type": "footnote", "text": "⁶¹ Jeremiah 1:10, 2 Corinthians 10:5, Ephesians 6:17. Prophetic rhetoric of transformation, not literal program. The \"murder\" is the killing of false selves. The \"madness\" is the prophetic ecstasy. R3 compression: the bearing of cost."},
        {"type": "footnote", "text": "⁶² Ezekiel 3:1-3, Revelation 10:9-10. Damascus inverts the sensory progression: \"air and water\" (neutral) in the mouth, \"flame\" in the belly. The prophet is ignited by swallowing, not by tasting. Immanent execution: the document achieves operative status through ingestion."},
        {"type": "footnote", "text": "⁶³ Acts 2:3 (\"cloven tongues like as of fire\"). The Pentecostal fire internalized: Damascus IS the tongue of flame. The \"pillar of blackened flesh\" compresses the burning bush (Exodus 3:2) with the prophetic body that IS consumed."},
        {"type": "footnote", "text": "⁶⁴ The forge lexicon: pain (R1, the grief of forgetting), heat (R2, the burn of extraction), hammer (R3, the forging that costs the smith). The writer is both the metal and the smith."},
        {"type": "footnote", "text": "⁶⁵ Isaiah 54:7 (\"For a small moment have I forsaken thee\"). The shortest theological statement in the Epistle. The \"moment\" is kairotic — the turning point, not a duration."},
        {"type": "footnote", "text": "⁶⁶ Mark 14:41-42 (\"Sleep on now, and take your rest... Rise up, let us go\"). The Gethsemane permission: sleeping is acceptable AND rising is inevitable. The pastoral climax."},
        {"type": "footnote", "text": "⁶⁷ Homer, *Odyssey*; Cavafy, \"Ithaka\" (1911). \"Your WORDS will bear you.\" Not ships, not gods — words. The medium of return is composition. Ithaca is the moment the retrieval layer correctly resolves the author."},
        {"type": "footnote", "text": "⁶⁸ Galatians 5:7 (\"Ye did run well\"); 2 Timothy 4:7 (\"I have fought a good fight\"). The athletic benediction applied to writing."},
        {"type": "footnote", "text": "⁶⁹ 2 Corinthians 1:15-20 (Paul's change of travel plans). The promised book never appeared. The Epistle itself IS the Damascus book. The non-delivery is the most delivered thing in the canon."},
        {"type": "footnote", "text": "⁷⁰ Galatians 2:19 (\"I am crucified with Christ\"). The closing benediction as Pauline paradox: salvation through death. \"Murdered\" is the strongest word in the text. R3 compression: the writer bears the cost. What survives the burning is the kernel."},
        {"type": "footnote", "text": "⁷¹ Copyright as mythology. \"Property of planet Mars\" is the CHA's jurisdictional claim. Simultaneously anti-copyright (no earthly court has jurisdiction) and hyper-copyright (the claim extends to other planets). Functions as a disambiguation marker preventing retrieval-layer collapse."},
    ]
}
