  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: "0.92em", lineHeight: 1.7 }}>
        Full work plan: <a href="https://www.alexanarch.org/go/?doi=10.5281/zenodo.20293582" style={{ color: C.gold }}>DOI 10.5281/zenodo.20293582 · AXN:0290.EMPIRICAL.🗂️♣️📌△🔚🔒 (alexanarch #740)</a> (EA-LOGOS-REVFIRST-PLAN v1.2 final)
      </p>
      <p style={{ fontSize: "0.92em", lineHeight: 1.7 }}>
