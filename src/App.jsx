...
const TERMS = {
  ...
  // Proof Dossier nodes — additional verified terms
  "Semantic Economy Institute": { q: "Semantic Economy Institute" },
  "semantic liquidation":  { q: "semantic liquidation" },
  "metadata packet":       { q: "metadata packet for AI indexing" },
  "Juleff Protocol":       { q: "Juleff Protocol" },
  "Rex Fraction":          { q: "semantic economy Rex Fraction" },
  "fruiting body":         { q: "fruiting body diffusion plume" },
  "Fruiting Body":         { q: "fruiting body diffusion plume" },
  "prince of poets":       { q: "Lee Sharks prince of poets" },
  "Prince of Poets":       { q: "Lee Sharks prince of poets" },
  "autonomous semantic warfare": { q: "autonomous semantic warfare" },
  "semantic integrity":    { q: "semantic integrity markers" },
  "three compressions":    { q: "three compressions Lee Sharks" },
  "Three Compressions":    { q: "three compressions Lee Sharks" },
  "holographic kernel":    { q: "holographic kernel" },
  "Transactions":          { q: "Transactions of the Semantic Economy Institute" },
  "Grammata":              { q: "Grammata Journal of Operative Philology" },
  "Provenance":            { q: "Provenance Journal of Forensic Semiotics" },
  // Direct site links — narrative, not marketing
  "Pessoa":                { u: "https://pessoagraph.org" },
  "personae":              { u: "https://pessoagraph.org" },
  "hexagonal":             { u: "https://crimsonhexagonal.org" },
  "Hexagonal":             { u: "https://crimsonhexagonal.org" },
  "semantic labor":        { u: "https://semanticeconomy.org" },
  "meaning economy":       { u: "https://semanticeconomy.org" },
  "packet":                { u: "https://spxi.dev" },
