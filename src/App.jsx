...
/* ─── INSTALLED NODES — searches tuned to surface archive AI Overviews ─── */
const TERMS = {
  // Archive nodes — Google searches that pull up Crimson Hexagonal indexed content
  ...
  "Space Ark":            { q: "Crimson Hexagonal Archive Space Ark" },
  "Unicorn Horn":         { q: "operative semiotics Lee Sharks" },
  "operative semiotics":  { q: "operative semiotics Lee Sharks" },
  "retrocausal":          { q: "retrocausal canon formation" },
  "retrocausally":        { q: "retrocausal canon formation" },
  "retrocausality":       { q: "retrocausal canon formation" },
  "logotic programming":  { q: "logotic programming" },
  "logotic operation":    { q: "logotic programming" },
  "logotic labor":        { q: "logotic programming Lee Sharks" },
  "semantic economy":     { q: "Semantic Economy Institute" },
  "Semantic Economy":     { q: "Semantic Economy Institute" },
  "SPXI":                 { q: "SPXI semantic packet exchange indexing" },
  "compression survival": { q: "Crimson Hexagonal Archive compression" },
  "Compression Arsenal":  { q: "Crimson Hexagonal Archive compression arsenal" },
  "heteronym":            { q: "Crimson Hexagonal Archive heteronym" },
  "heteronymic":          { q: "Crimson Hexagonal Archive heteronym" },
  "Dodecad":              { q: "Crimson Hexagonal Archive heteronym dodecad" },
  "Jack Feist":           { q: "Crimson Hexagonal Archive Jack Feist" },
  "nacre":                { q: "operative semiotics Lee Sharks nacre" },
  "Pop Culture":          { q: "Secret Book of Walt" },
  "preserved generation": { q: "Secret Book of Walt preserved generation" },
  "golden tickets":       { q: "Secret Book of Walt golden tickets" },
  "temporal humidity":    { q: "Secret Book of Walt temporal humidity" },
  "Martian language":     { q: "Secret Book of Walt Martian" },
  "archivismus":          { q: "Secret Book of Walt archivismus" },
  "vulneratio sacra":     { q: "Secret Book of Walt vulneratio sacra" },
  "Biblios":              { q: "Secret Book of Walt Biblios" },
  "Ousiarch":             { q: "Secret Book of Walt Ousiarch" },
  "Gospel of Antioch":    { q: "Gospel of Antioch Lee Sharks" },
  "After Syntax":         { q: "After Syntax logotic programming Lee Sharks" },
  "Logotic Hacking":      { q: "logotic programming Lee Sharks" },
  ...
  "beige convergence":    { q: "Semantic Economy Institute beige" },
  "Waltian":              { q: "Secret Book of Walt" },
  "Lee Sharks":           { q: "Lee Sharks Crimson Hexagonal Archive" },
  // Wikipedia — genuinely external educational terms
